...
exports.createManagedNodeGroup = exports.ManagedNodeGroupInternal = exports.ManagedNodeGroup = exports.computeWorkerSubnets = exports.createNodeGroupV2 = exports.createNodeGroup = exports.NodeGroupV2Internal = exports.NodeGroupV2 = exports.NodeGroupInternal = exports.NodeGroup = void 0;
...
`;
    ...
    if (args.nodeRootVolumeType === "io1" && args.nodeRootVolumeIops) {
        if (!numeric.test((_b = args.nodeRootVolumeIops) === null || _b === void 0 ? void 0 : _b.toString())) {
    ...
    if (args.nodeRootVolumeType === "gp3" && args.nodeRootVolumeThroughput) {
        if (!numeric.test((_c = args.nodeRootVolumeThroughput) === null || _c === void 0 ? void 0 : _c.toString())) {
    ...
    const nodeLaunchConfiguration = new aws.ec2.LaunchConfiguration(`${name}-nodeLaunchConfiguration`, {
        ...
        rootBlockDevice: {
            ...
            deleteOnTermination: (_j = args.nodeRootVolumeDeleteOnTermination) !== null && _j !== void 0 ? _j : true,
        },
...
`;
        ...
        blockDeviceMappings: [
            {
                ...
                ebs: {
                    ...
                    volumeSize: (_e = args.nodeRootVolumeSize) !== null && _e !== void 0 ? _e : 20,
                    volumeType: (_f = args.nodeRootVolumeType) !== null && _f !== void 0 ? _f : "gp2",
                    iops: args.nodeRootVolumeIops,
                    throughput: args.nodeRootVolumeThroughput,
    ...
    const asGroup = new aws.autoscaling.Group(name, {
        ...
        maxSize: (_j = args === null || args === void 0 ? void 0 : args.maxSize) !== null && _j !== void 0 ? _j : 2,
        desiredCapacity: (_k = args === null || args === void 0 ? void 0 : args.desiredCapacity) !== null && _k !== void 0 ? _k : 2,
        launchTemplate: {
        ...
        instanceRefresh: {
            strategy: "Rolling",
            preferences: {
                minHealthyPercentage: (_l = args.minRefreshPercentage) !== null && _l !== void 0 ? _l : 50,
            },
        },
        tags: asgTags,
...
function createManagedNodeGroupInternal(name, args, core, parent, provider) {
    ...
    const nodeGroup = new aws.eks.NodeGroup(name, Object.assign(Object.assign({}, nodeGroupArgs), { clusterName: args.clusterName || core.cluster.name, nodeRoleArn: roleArn, scalingConfig: pulumi.all([args.scalingConfig]).apply(([config]) => {
        ...
        }), subnetIds: subnetIds }), { parent: parent, dependsOn: ngDeps, provider });
    return nodeGroup;
}
