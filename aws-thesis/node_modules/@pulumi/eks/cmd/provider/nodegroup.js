...
exports.nodeGroupV2ProviderFactory = exports.managedNodeGroupProviderFactory = exports.nodeGroupProviderFactory = void 0;
const nodegroup_1 = require("../../nodegroup");
const nodeGroupProvider = {
    construct: (name, type, inputs, options) => {
        try {
            const nodegroup = new nodegroup_1.NodeGroupInternal(name, inputs, options);
...
const managedNodeGroupProvider = {
    construct: (name, type, inputs, options) => {
        try {
            const nodegroup = new nodegroup_1.ManagedNodeGroupInternal(name, inputs, options);
            return Promise.resolve({
                urn: nodegroup.urn,
                state: {
...
const nodeGroupV2Provider = {
    construct: (name, type, inputs, options) => {
        try {
            const nodegroup = new nodegroup_1.NodeGroupV2Internal(name, inputs, options);
            return Promise.resolve({
                urn: nodegroup.urn,
                state: {
                    nodeSecurityGroup: nodegroup.nodeSecurityGroup,
...
/** @internal */
function nodeGroupV2ProviderFactory() {
    return nodeGroupV2Provider;
}
exports.nodeGroupV2ProviderFactory = nodeGroupV2ProviderFactory;
