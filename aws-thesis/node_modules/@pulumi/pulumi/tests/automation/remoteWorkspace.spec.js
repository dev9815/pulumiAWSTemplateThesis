...
describe("RemoteWorkspace", () => {
    describe("remote cmd args", () => {
        ...
        tests.forEach(test => {
            it(`${test.name}`, () => __awaiter(void 0, void 0, void 0, function* () {
                const ws = yield automation_1.LocalWorkspace.create(test.opts);
                const actual = ws.remoteArgs();
                assert_1.default.deepStrictEqual(actual, test.expected);
            }));
        });
    });
